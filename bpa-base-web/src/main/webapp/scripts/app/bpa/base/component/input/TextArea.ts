...
import TextAreaOptions = require("bpa/base/component/input/TextAreaOptions");
import ValidatorRule = require("bpa/base/component/input/ValidatorRule");

class TextArea extends Component implements FormInput {
    ...
    constructor(theOptions: TextAreaOptions) {
        super(theOptions);
