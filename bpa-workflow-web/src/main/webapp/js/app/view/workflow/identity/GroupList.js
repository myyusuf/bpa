define(["bpaObservable", "jQuery", "jqxcore", "jqxbuttons", "jqxdata", "jqxinput", "jqxmenu",
	...
	var GroupList = function(container, options){
        ...
        var _groupListGrid = container.jqxGrid(
        {
            ...
            columns: [
              { text: 'Group Id', datafield: 'groupId', width: '25%' },
        ...
        var _getGroupFromRowData = function(rowData){
        	...
        	if(rowData){
        		_group.groupId = rowData.groupId;
            	_group.firstName = rowData.firstName;
            	_group.lastName = rowData.lastName;
            	_group.email = rowData.email;
        	}
